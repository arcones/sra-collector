...
def handler(event, context):
    if event:
        ...
        for record in event['Records']:
            ...
            logging.info(f'Query received for keyword {ncbi_query} with retstart {retstart} and retmax {retmax}')
            ...
            logging.info(f"Study list contains: {','.join(map(str,sorted(study_list)))}")
